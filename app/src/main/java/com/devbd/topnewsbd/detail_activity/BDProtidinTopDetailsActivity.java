...
public class BDProtidinTopDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bdprotidin_top_details);
        ...
        url = intent.getStringExtra(Constant.BDPROTIDIN_TOP_DETAIL_INFO);
...
//                intent.putExtra(Constant.BDNEWS_TITLE, title);
        ...
        new BdProtidinTopDetailsJsoup().execute();
    ...
    private class BdProtidinTopDetailsJsoup extends AsyncTask<Void,Void,Boolean>{
...
//            }
    ...
    private Context getDialogContext(){
        ...
        if(getApplicationContext() != null)
            context = BDProtidinTopDetailsActivity.this;
        else
            context = BDProtidinTopDetailsActivity.this;
