...
public class KalerkanthoLatestDeatilsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalerkantho_latest_deatils);
        ...
        url = intent.getStringExtra(Constant.KALER_KANTHO_LATEST_DETAIL_INFO);
        ...
        new KalerKanthoLatestDetailsJsoup().execute();
    ...
    private class KalerKanthoLatestDetailsJsoup extends AsyncTask<Void,Void,Boolean>{
...
//                    getDetailsValue = mDetails.text();
    ...
    private Context getDialogContext(){
        ...
        if(getApplicationContext() != null)
            context = KalerkanthoLatestDeatilsActivity.this;
        else
            context = KalerkanthoLatestDeatilsActivity.this;
