...
public class NtvNewsTopDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ntv_news_top_details);
        ...
        url = intent.getStringExtra(Constant.NTVNEWS_TOP_DETAIL_INFO);
...
//                intent.putExtra(Constant.KALER_KANTHO_TITLE, title);
        ...
        new NtvNewsTopDetailsJsoup().execute();
    }


    private class NtvNewsTopDetailsJsoup extends AsyncTask<Void,Void,Boolean> {
...
//                    getDetailsValue = mDetails.text();
    ...
    private Context getDialogContext(){
        ...
        if(getApplicationContext() != null)
            context = NtvNewsTopDetailsActivity.this;
        else
            context = NtvNewsTopDetailsActivity.this;
