...
public class BBCBanglaLatestDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bbcbangla_latest_details);
        ...
        url = intent.getStringExtra(Constant.BBCBANGLA_LATEST_DETAIL_INFO);
...
//                intent.putExtra(Constant.BDNEWS_TITLE, title);
        ...
        new BBCBANGLALatestDetailsJsoup().execute();
    ...
    private class BBCBANGLALatestDetailsJsoup extends AsyncTask<Void,Void,Boolean>{
...
//                    getDetailsValue = mDetails.text();
    ...
    private Context getDialogContext(){
        ...
        if(getApplicationContext() != null)
            context = BBCBanglaLatestDetailsActivity.this;
        else
            context = BBCBanglaLatestDetailsActivity.this;
