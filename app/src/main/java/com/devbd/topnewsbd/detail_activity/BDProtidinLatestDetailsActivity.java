...
public class BDProtidinLatestDetailsActivity extends AppCompatActivity {
    ...
    private String title ="বিডি প্রতিদিন";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bdprotidin_latest_details);
        ...
        url = intent.getStringExtra(Constant.BDPROTIDIN_LATEST_DETAIL_INFO);
...
//                intent.putExtra(Constant.BDNEWS_TITLE, title);
        ...
        new BdProtidinLatestDetailsJsoup().execute();
    ...
    private class BdProtidinLatestDetailsJsoup extends AsyncTask<Void,Void,Boolean>{
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                Elements dataMinimize = doc.select("div.span8");

                //getting news title
                Element mTitle = dataMinimize.select("div#hl2").first();
                Log.i("morshed",mTitle.text());


                //getting news date
                Element mDate = dataMinimize.select("div.span8 > span").first();
...
//          TODO      Elements mDetails = dataMinimize.select("div.newsDtl > p");
                Element mDetails = doc.select("div#newsDtl").first();



//        TODO        for (int j=0; j<2; j++) {
...
//            }
    ...
    private Context getDialogContext(){
        ...
        if(getApplicationContext() != null)
            context = BDProtidinLatestDetailsActivity.this;
        else
            context = BDProtidinLatestDetailsActivity.this;
