...
public class SamakalTopDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samakal_top_details);
        ...
        intent = getIntent();
        url = intent.getStringExtra(Constant.SAMAKAL_TOP_DETAIL_INFO);
        Log.i("morshed",url);
...
//                intent.putExtra(Constant.BDNEWS_TITLE, title);
        ...
        new SamakaTopDetailsJsoup().execute();

    }

    private class SamakaTopDetailsJsoup extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                //getting news title
                Element mTitle = doc.select("div#hl2 > h1").first();
                //getting news date
                Elements mDate = doc.select("tr > td > span#news_publish_time");
...
//            }
    ...
    private Context getDialogContext() {
        ...
        if (getApplicationContext() != null)
            context = SamakalTopDetailsActivity.this;
        else
            context = SamakalTopDetailsActivity.this;
