...
public class BangladeshProtidinCustomFragmentAdapter extends FragmentPagerAdapter {
    public BangladeshProtidinCustomFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                LatestNewsBangladeshProtidin latestNews = new LatestNewsBangladeshProtidin();
                return latestNews;
            default:
                // The other sections of the app are dummy placeholders.
                Fragment fragment = new TopViewNewsBangladeshProtidin();
