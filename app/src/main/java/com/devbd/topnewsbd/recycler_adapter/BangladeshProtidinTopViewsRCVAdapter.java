...
public class BangladeshProtidinTopViewsRCVAdapter extends RecyclerView.Adapter<BangladeshProtidinTopViewsRCVAdapter.BangladeshProtidinTopViewsVWHolder> {

    private ArrayList<BangladeshProtidinTopViewModel> latestNews = new ArrayList<>();
    ...
    @Override
    public BangladeshProtidinTopViewsVWHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_card_layout_with_img_title,parent,false);
        return new BangladeshProtidinTopViewsVWHolder(view);
...
//         holder.news_img.setImageDrawable(R.drawable.ic_menu_gallery);
    ...
    public class BangladeshProtidinTopViewsVWHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public BangladeshProtidinTopViewsVWHolder(View itemView) {
            super(itemView);
    ...
    public void SetOnItemClickListener(final BangladeshProtidinTopViewsRCVAdapter.OnItemClickListener onItemClickListener){
