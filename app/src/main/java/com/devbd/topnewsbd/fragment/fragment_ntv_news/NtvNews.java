...
import com.devbd.topnewsbd.adapter.NtvNewsCustomFragmentAdapter;
 ...
 */
public class NtvNews extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dmpnews, container, false);
        getActivity().setTitle("এনটিভি নিউজ");
        tabLayout = (TabLayout)view.findViewById(R.id.tabs);
        viewPager = (ViewPager)view.findViewById(R.id.view_pager);

        viewPager.setAdapter(new NtvNewsCustomFragmentAdapter(getChildFragmentManager()));
