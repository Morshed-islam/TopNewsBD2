...
import com.devbd.topnewsbd.adapter.BBCBanglaCustomAdapter;
 ...
 */
public class BBCBangla extends Fragment {

    private TabLayout tabLayout;
    private ViewPager viewPager;

    private BBCBanglaCustomAdapter customAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new BBCBanglaCustomAdapter(getChildFragmentManager()));
