...
import com.devbd.topnewsbd.adapter.SamakalCustomFragmentAdapter;
 ...
 */
public class Samakal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_samakal, container, false);
        getActivity().setTitle("সমকাল");
        tabLayout = (TabLayout)view.findViewById(R.id.tabs);
        viewPager = (ViewPager)view.findViewById(R.id.view_pager);

        viewPager.setAdapter(new SamakalCustomFragmentAdapter(getChildFragmentManager()));
